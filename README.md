...
html과 css에 대해 강의 외적인 부분으로 공부를 해보니 코드를 작성하는데 있어 이해도도 증가하고 사용할 수 있는 기술도 많아져 정말 유의미한 시간이었습니다. 협업에서 코드를 취합하는데 있어 git을 사용하다보니 숙련도가 월등히 증가하였고 좋은 팀원분들을 만나 무사히 프로젝트를 마무리할 수 있어 기뻤습니다. 다들 진심으로 감사드립니다.
